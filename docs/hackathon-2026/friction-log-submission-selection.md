...
The final strict public smoke is GitHub Actions run `35462460140`: MCP 2025-11-25, six tools, Apgar 9/10, and SIM `school-bus` / patient `01` / expected `GREEN` / `correct=true` / rule `JS-MOB-01`, with all assertions passing.
