...
| `who_growth_module` | `who-growth` | growth_nutrition | `pending_validation` | `blocked_missing_complete_scoring_table` | Core WHO 0-5 imported; WHO 5-19 and interpolation policy pending | `implement_after_chart_and_ui_review` | yes |
