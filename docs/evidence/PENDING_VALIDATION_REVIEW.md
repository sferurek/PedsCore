...
| A | `who_growth_module` | `who-growth` | growth_nutrition | Unified WHO module scaffold created; core WHO 0-5 LMS indicators imported from official WHO XLSX tables under separate WHO data license. WHO 5-19 and interpolation policy pending. | `pending_complete_scoring_table` |
...
| WHO Growth Module | Official WHO 0-5 and 5-19 source pages verified; core WHO 0-5 LMS indicators imported from official WHO XLSX tables. | Core WHO 0-5 data imported with SVG charts/print; WHO 5-19 and interpolation policy pending. | Medium; WHO data license kept separate from MIT. | `pending_complete_scoring_table` |
...
| `who_growth_module` | `who-growth` | growth_nutrition | `pending_validation` | `blocked_requires_domain_expert_review` | Core WHO 0-5 imported; WHO 5-19 BMI-for-age and height-for-age imported; remaining 5-19 scope/interpolation/final review pending | `implement_after_chart_and_ui_review` | yes |
...
| `who_growth_module` | yes | Percentiles WHO/CDC |
