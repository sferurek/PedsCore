...
| A | `who_growth_module` | `who-growth` | growth_nutrition | Unified WHO module scaffold created; BMI-for-age 0-5 LMS imported from official WHO XLSX tables under separate WHO data license. UI, graph, print and remaining indicators pending. | `pending_complete_scoring_table` |
...
| WHO Growth Module | Official WHO 0-5 and 5-19 source pages verified; BMI-for-age 0-5 LMS imported from official WHO XLSX tables. | BMI-for-age data imported; remaining indicators, UI/graph/print and interpolation policy pending. | Medium; WHO data license kept separate from MIT. | `pending_complete_scoring_table` |
...
| `who_growth_module` | `who-growth` | growth_nutrition | `pending_validation` | `blocked_missing_complete_scoring_table` | BMI-for-age 0-5 imported; remaining indicators and UI/graph/print pending | `implement_after_chart_and_ui_review` | yes |
