...
| Growth | WHO unified growth module | WHO Child Growth Standards, WHO Growth Reference 5-19 years, and WHO `anthro` BMI LMS source. https://www.who.int/tools/child-growth-standards, https://www.who.int/tools/growth-reference-data-for-5to19-years, https://github.com/WorldHealthOrganization/anthro | Official WHO source pages located; core WHO 0-5 LMS indicators imported from official XLSX files. | WHO 0-5 data imported under separate WHO data terms; no official chart image copied. |
...
| who-growth | pending_validation | license-sensitive | Unified WHO scaffold added; core WHO 0-5 LMS datasets imported from official WHO XLSX files under separate WHO data terms. |
...
| `who_growth_module` / `who_growth_percentiles` / `cdc_growth_percentiles` | `maintainer_scope_policy` | keep pending_validation | Core WHO 0-5 LMS import and printable chart labels are available; WHO 5-19, interpolation policy, and age-boundary governance remain pending. |
