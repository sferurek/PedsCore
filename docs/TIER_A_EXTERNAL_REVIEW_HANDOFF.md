...
> I am asking you to independently verify the clinical fidelity of 15 high-risk pediatric tools in PedsCore. You do not need to review the code. Please compare each visible implementation with its primary/authoritative source, use the checklist in the review pack, and record any discrepancy. Please do not enter identifiable patient data. The version is frozen by commit SHA so your review remains reproducible.
