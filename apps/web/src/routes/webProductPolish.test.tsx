...
describe("public product web polish", () => {
  ...
  it("keeps catalog implementation counts and completed WHO Growth preset IDs", () => {
  ...
  it("renders WHO Growth as an active completed module", () => {
    ...
    expect(html).not.toContain("Active partial module");
