...
const fridericiaEn = await read("en/tools/qtc-fridericia/index.html");
const bazettEn = await read("en/tools/qtc-bazett/index.html");
const comfortneoEs = await read("es/tools/comfortneo/index.html");
const scoffEn = await read("en/tools/scoff/index.html");
const pcdaiEs = await read("es/tools/pcdai/index.html");
...
assertIncludes(fridericiaEn, "<title>QTc Fridericia Calculator — Pediatric ECG | PedsCore</title>", "Fridericia query-led title");
assertIncludes(bazettEn, "<title>QTc Bazett Calculator — Pediatric ECG | PedsCore</title>", "Bazett query-led title");
assertIncludes(comfortneoEs, "<title>COMFORTneo — Dolor y sedación neonatal | PedsCore</title>", "COMFORTneo query-led title");
assertIncludes(scoffEn, "<title>SCOFF Questionnaire — Eating Disorder Screening | PedsCore</title>", "SCOFF query-led title");
assertIncludes(pcdaiEs, "<title>PCDAI — Actividad de Crohn pediátrico | PedsCore</title>", "PCDAI query-led title");
assertIncludes(chaliceEn, "<title>CHALICE Rule — Pediatric Head Injury | PedsCore</title>", "CHALICE query-led title");
