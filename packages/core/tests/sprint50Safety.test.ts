...
const implementedTestFiles: Record<string, string> = {
  ...
  pucai: "pucai.test.ts",
  pcdai: "pcdai.test.ts",
  pass: "unlockedClinicalScores.test.ts",
  gorelick_dehydration: "unlockedClinicalScores.test.ts",
  prifle: "unlockedClinicalScores.test.ts",
  pelod_2: "unlockedClinicalScores.test.ts",
  prism_iv: "unlockedClinicalScores.test.ts",
  pim3: "unlockedClinicalScores.test.ts",
  psofa: "psofaSnappe.test.ts",
  snappii: "psofaSnappe.test.ts",
