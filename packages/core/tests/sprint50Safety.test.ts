...
const implementedTestFiles: Record<string, string> = {
  ...
  pucai: "pucai.test.ts",
  pcdai: "pcdai.test.ts",
  pass: "unlockBatch.test.ts",
  gorelick_dehydration: "unlockBatch.test.ts",
  prifle: "unlockBatch.test.ts",
  pelod_2: "unlockBatch.test.ts",
  prism_iv: "unlockBatch.test.ts",
  pim3: "unlockBatch.test.ts",
  psofa: "unlockBatch.test.ts",
  fnass_21: "fnast21.test.ts",
  rdai: "rdaiSnappe.test.ts",
  snappii: "rdaiSnappe.test.ts",
