...
export const clinicalTools: ClinicalToolMetadata[] = [
  ...
  makeTool("pass", "pass", "PASS", "Pediatric Asthma Severity Score", "Pediatric Asthma Severity Score", "respiratory", "asthma", "score", "Ninos de 1 a 18 anos con asma aguda", "Children aged 1 to 18 years with acute asthma", "PASS de 3 dominios para gravedad de asma aguda.", "Three-domain PASS for acute asthma severity.", "implemented", "original_derivation_study", "medium", passValidationNotes),
  ...
  makeTool("gorelick_dehydration", "gorelick-dehydration", "Gorelick", "Escala de Gorelick", "Gorelick Dehydration Scale", "emergency", "dehydration", "score", "Ninos de 1 mes a 5 anos con sospecha de deshidratacion", "Children aged 1 month to 5 years with suspected dehydration", "Escala de Gorelick de 10 signos para estimar deshidratacion.", "Ten-sign Gorelick scale for dehydration assessment.", "implemented", "original_derivation_study", "medium", gorelickValidationNotes),
  ...
  makeTool("prism_iv", "prism-iv", "PRISM IV", "PRISM IV", "PRISM IV", "intensive_care", "mortality_risk", "score", "Ninos ingresados en UCI pediatrica", "Children admitted to pediatric ICU", "Modelo PRISM IV con subpuntajes fisiologicos y probabilidad de mortalidad hospitalaria.", "PRISM IV model with physiologic subscores and hospital-mortality probability.", "implemented", "original_derivation_study", "high", {es:"El articulo original de PRISM IV coloca expresamente los algoritmos de prediccion en dominio publico. PedsCore reproduce el modelo con advertencias de uso pronostico poblacional.",en:"The original PRISM IV paper explicitly places the prediction algorithms in the public domain. PedsCore implements the model with population-prognosis safeguards."}),
  ...
  makeTool("pim3", "pim3", "PIM3", "PIM3", "PIM3", "intensive_care", "mortality_risk", "score", "Ninos ingresados en UCI pediatrica", "Children admitted to pediatric ICU", "PIM3 con ecuacion publicada para estimacion de mortalidad poblacional.", "PIM3 with the published equation for population-level mortality estimation.", "implemented", "external_validation_study", "high", {es:"Ecuacion PIM3 y coeficientes verificados en literatura abierta y documentacion de registro; uso para benchmarking y estratificacion, no para decisiones individuales.",en:"PIM3 equation and coefficients verified in open literature and registry documentation; intended for benchmarking and stratification, not individual management decisions."}),
  makeTool(
    "who_growth_module",
    "who-growth",
    "OMS",
