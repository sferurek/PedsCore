...
export const clinicalTools: ClinicalToolMetadata[] = [
  ...
  makeTool("risc", "risc", "RISC", "Respiratory Index of Severity in Children (RISC)", "Respiratory Index of Severity in Children (RISC)", "respiratory", "pneumonia", "score", "Menores de 24 meses hospitalizados por infeccion respiratoria baja; implementacion local del modelo original sin VIH", "Children under 24 months hospitalized with lower respiratory tract infection; local implementation of the original HIV-uninfected model", "Predice riesgo de mortalidad mediante hipoxemia/retracciones, sibilancias, rechazo de tomas y peso para la edad.", "Predicts mortality risk using hypoxemia/chest indrawing, wheezing, refusal to feed, and weight-for-age.", "implemented", "original_derivation_study", "medium", { es: "Modelo sin VIH verificado frente a Reed et al. 2012 (PLoS ONE, CC0). El modelo VIH positivo requiere una parametrizacion distinta y no se mezcla con este calculo.", en: "HIV-uninfected model verified against Reed et al. 2012 (PLoS ONE, CC0). The HIV-infected model requires separate parameters and is not mixed into this calculation." }),
  makeTool("mrisc", "mrisc", "mRISC", "mRISC", "mRISC", "respiratory", "pneumonia", "score", "Menores de 5 anos hospitalizados con enfermedad respiratoria aguda", "Hospitalized children under 5 years with acute respiratory illness", "Modelo pronostico derivado en Kenia que combina hipoxemia, tiraje, sibilancias, rechazo de tomas, deshidratacion y peso para la edad.", "Prognostic model derived in Kenya combining hypoxemia, chest indrawing, wheezing, refusal to feed, dehydration, and weight-for-age.", "implemented", "original_derivation_study", "medium", { es: "Tabla de puntos verificada frente al estudio original de Emukule et al. 2014, publicado en PLOS ONE con acceso abierto.", en: "Point table verified against the original Emukule et al. 2014 study, published open access in PLOS ONE." }),
  ...
  makeTool("kdigo_pediatric", "kdigo-pediatric", "KDIGO pediatrico", "KDIGO pediatrico", "Pediatric KDIGO", "nephrology", "acute_kidney_injury", "clinical_rule", "Ninos y adolescentes con riesgo de lesion renal aguda", "Children and adolescents at risk of acute kidney injury", "Clasificacion KDIGO 1-3 por creatinina y diuresis, incluida la modificacion pediatrica de estadio 3 por eGFR <35 mL/min/1,73 m2.", "KDIGO stages 1-3 by creatinine and urine output, including the pediatric stage-3 modification for eGFR <35 mL/min/1.73 m2.", "implemented", "clinical_practice_guideline", "medium", { es: "Criterios verificados frente a la guia KDIGO 2012; se aplica el peor criterio entre creatinina y diuresis.", en: "Criteria verified against the 2012 KDIGO guideline; the worse of creatinine and urine-output criteria is applied." }),
  ...
  makeTool("pelod_2", "pelod-2", "PELOD-2", "PELOD-2", "PELOD-2", "intensive_care", "organ_dysfunction", "score", "Ninos criticamente enfermos en UCI pediatrica", "Critically ill children in the PICU", "Score de 10 variables y cinco sistemas para cuantificar disfuncion organica multiple pediatrica.", "Ten-variable, five-organ-system score quantifying pediatric multiple organ dysfunction.", "implemented", "original_derivation_study", "high", { es: "PELOD-2 verificado frente a Leteurtre et al. 2013 y tablas abiertas posteriores. El articulo original declara que el score queda en dominio publico para su libre uso.", en: "PELOD-2 verified against Leteurtre et al. 2013 and later open tables. The original article states that the score is in the public domain for free use." }),
