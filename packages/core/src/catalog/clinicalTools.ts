...
export const clinicalTools: ClinicalToolMetadata[] = [
  ...
  makeTool("pass", "pass", "PASS", "Pediatric Asthma Severity Score", "Pediatric Asthma Severity Score", "respiratory", "asthma", "score", "Ninos de 1 a 18 anos con asma aguda", "Children aged 1 to 18 years with acute asthma", "PASS de 3 dominios para cuantificar gravedad clínica en asma aguda pediátrica.", "Three-domain PASS for clinical severity assessment in pediatric acute asthma.", "implemented", "original_derivation_study", "medium", passValidationNotes),
  ...
  makeTool("gorelick_dehydration", "gorelick-dehydration", "Gorelick", "Escala de Gorelick", "Gorelick Dehydration Scale", "emergency", "dehydration", "score", "Ninos de 1 mes a 5 anos con sospecha de deshidratacion", "Children aged 1 month to 5 years with suspected dehydration", "Escala de 10 signos para estimar clínicamente deshidratación pediátrica.", "Ten-sign scale for clinical estimation of pediatric dehydration.", "implemented", "original_derivation_study", "medium", gorelickValidationNotes),
  ...
  makeTool("prism_iv", "prism-iv", "PRISM IV", "PRISM IV", "PRISM IV", "intensive_care", "mortality_risk", "score", "Ninos ingresados en UCI pediatrica", "Children admitted to pediatric ICU", "Modelo PRISM IV para estimación poblacional de mortalidad en UCI pediátrica; el algoritmo de predicción fue puesto en dominio público.", "PRISM IV population-level PICU mortality model; the prediction algorithm was placed in the public domain.", "implemented", "original_derivation_study", "high", clinicalToolFormMetadata.prism_iv?.validationNotes ?? baseValidationNotes.pending),
  ...
  makeTool("pim3", "pim3", "PIM3", "PIM3", "PIM3", "intensive_care", "mortality_risk", "score", "Ninos ingresados en UCI pediatrica", "Children admitted to pediatric ICU", "Modelo PIM3 para estimación poblacional de mortalidad a partir de variables de la primera hora de UCI.", "PIM3 population-level mortality model using variables from the first hour of intensive care.", "implemented", "original_derivation_study", "high", clinicalToolFormMetadata.pim3?.validationNotes ?? baseValidationNotes.pending),
  makeTool(
    "who_growth_module",
    "who-growth",
    "OMS",
