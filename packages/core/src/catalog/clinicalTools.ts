...
const clinicalToolFormMetadata: Record<string, Partial<ClinicalToolMetadata>> = {
  ...
  phoenix_sepsis: {
    ...
    inputs: [
      ...
      { id: "fio2_fraction", label: { es: "FiO₂ (si se usa P/F o S/F)", en: "FiO₂ (if using P/F or S/F)" }, type: "number", required: false, unit: "0-1", min: 0.21, max: 1, step: 0.01 , visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] },
      { id: "pao2_mmhg", label: { es: "PaO₂ (si disponible)", en: "PaO₂ (if available)" }, type: "number", required: false, unit: "mmHg", min: 1, max: 800, step: 1 , visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] },
      { id: "spo2_percent", label: { es: "SpO₂ (S/F solo válido si ≤97%)", en: "SpO₂ (S/F valid only if ≤97%)" }, type: "number", required: false, unit: "%", min: 1, max: 100, step: 1 , visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] },
      { ...booleanInput("any_respiratory_support", { es: "Cualquier soporte respiratorio", en: "Any respiratory support" }), visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] },
      { ...booleanInput("invasive_mechanical_ventilation", { es: "Ventilación mecánica invasiva", en: "Invasive mechanical ventilation" }), visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] },
      { id: "vasoactive_count", label: { es: "Número de vasoactivos (si conocido)", en: "Number of vasoactive medications (if known)" }, type: "number", required: false, min: 0, max: 10, step: 1 , visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] },
      { id: "lactate_mmol_l", label: { es: "Lactato (si medido)", en: "Lactate (if measured)" }, type: "number", required: false, unit: "mmol/L", min: 0, max: 30, step: 0.1 , visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] },
      { id: "map_mmhg", label: { es: "PAM (si medida)", en: "MAP (if measured)" }, type: "number", required: false, unit: "mmHg", min: 0, max: 200, step: 1 , visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] },
      { id: "platelets_10e3_ul", label: { es: "Plaquetas (si medidas)", en: "Platelets (if measured)" }, type: "number", required: false, unit: "×10³/µL", min: 0, max: 1500, step: 1 , visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] },
      { id: "inr", label: { es: "INR (si medido)", en: "INR (if measured)" }, type: "number", required: false, min: 0, max: 20, step: 0.01 , visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] },
      { id: "d_dimer_mg_l_feu", label: { es: "Dímero D FEU (si medido)", en: "D-dimer FEU (if measured)" }, type: "number", required: false, unit: "mg/L", min: 0, max: 100, step: 0.01 , visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] },
      { id: "fibrinogen_mg_dl", label: { es: "Fibrinógeno (si medido)", en: "Fibrinogen (if measured)" }, type: "number", required: false, unit: "mg/dL", min: 0, max: 1500, step: 1 , visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] },
      { id: "gcs", label: { es: "GCS (si valorable)", en: "GCS (if assessable)" }, type: "number", required: false, min: 3, max: 15, step: 1 , visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] },
      { id:"both_pupils_fixed", label:{es:"Ambas pupilas fijas (si valorable)",en:"Both pupils fixed (if assessable)"}, type:"boolean", required:false, options:booleanOptions, visibleWhen: [{ inputId: "birth_hospitalization_before_discharge", operator: "equals", value: false }, { inputId: "postconceptional_age_at_least_37_weeks", operator: "equals", value: true }] }
    ]
  },
  visual_analogue_scale: {
    validationNotes: {
  ...
  pecarn_tbi_under_2: {
    ...
    inputs: [
      ...
      { ...booleanInput("altered_mental_status_or_gcs_less_than_15",{es:"Alteración mental o GCS <15",en:"Altered mental status or GCS <15"}), visibleWhen: [{ inputId: "blunt_head_trauma", operator: "equals", value: true }, { inputId: "presentation_within_24h", operator: "equals", value: true }, { inputId: "trivial_mechanism_only", operator: "equals", value: false }, { inputId: "penetrating_trauma", operator: "equals", value: false }, { inputId: "known_brain_tumor", operator: "equals", value: false }, { inputId: "preexisting_neurologic_disorder_complicating_assessment", operator: "equals", value: false }, { inputId: "prior_neuroimaging_before_transfer", operator: "equals", value: false }, { inputId: "ventricular_shunt", operator: "equals", value: false }, { inputId: "bleeding_disorder", operator: "equals", value: false }] },
      { ...booleanInput("palpable_skull_fracture",{es:"Fractura craneal palpable",en:"Palpable skull fracture"}), visibleWhen: [{ inputId: "blunt_head_trauma", operator: "equals", value: true }, { inputId: "presentation_within_24h", operator: "equals", value: true }, { inputId: "trivial_mechanism_only", operator: "equals", value: false }, { inputId: "penetrating_trauma", operator: "equals", value: false }, { inputId: "known_brain_tumor", operator: "equals", value: false }, { inputId: "preexisting_neurologic_disorder_complicating_assessment", operator: "equals", value: false }, { inputId: "prior_neuroimaging_before_transfer", operator: "equals", value: false }, { inputId: "ventricular_shunt", operator: "equals", value: false }, { inputId: "bleeding_disorder", operator: "equals", value: false }] },
      { ...booleanInput("non_frontal_scalp_hematoma",{es:"Hematoma no frontal",en:"Non-frontal scalp hematoma"}), visibleWhen: [{ inputId: "blunt_head_trauma", operator: "equals", value: true }, { inputId: "presentation_within_24h", operator: "equals", value: true }, { inputId: "trivial_mechanism_only", operator: "equals", value: false }, { inputId: "penetrating_trauma", operator: "equals", value: false }, { inputId: "known_brain_tumor", operator: "equals", value: false }, { inputId: "preexisting_neurologic_disorder_complicating_assessment", operator: "equals", value: false }, { inputId: "prior_neuroimaging_before_transfer", operator: "equals", value: false }, { inputId: "ventricular_shunt", operator: "equals", value: false }, { inputId: "bleeding_disorder", operator: "equals", value: false }] },
      { ...booleanInput("loss_of_consciousness_5_seconds_or_more",{es:"Pérdida de conciencia ≥5 s",en:"Loss of consciousness ≥5 s"}), visibleWhen: [{ inputId: "blunt_head_trauma", operator: "equals", value: true }, { inputId: "presentation_within_24h", operator: "equals", value: true }, { inputId: "trivial_mechanism_only", operator: "equals", value: false }, { inputId: "penetrating_trauma", operator: "equals", value: false }, { inputId: "known_brain_tumor", operator: "equals", value: false }, { inputId: "preexisting_neurologic_disorder_complicating_assessment", operator: "equals", value: false }, { inputId: "prior_neuroimaging_before_transfer", operator: "equals", value: false }, { inputId: "ventricular_shunt", operator: "equals", value: false }, { inputId: "bleeding_disorder", operator: "equals", value: false }] },
      { ...booleanInput("severe_mechanism",{es:"Mecanismo grave PECARN (<2 a): caída >0,9 m u otros criterios publicados",en:"PECARN severe mechanism (<2 y): fall >0.9 m or other published criteria"}), visibleWhen: [{ inputId: "blunt_head_trauma", operator: "equals", value: true }, { inputId: "presentation_within_24h", operator: "equals", value: true }, { inputId: "trivial_mechanism_only", operator: "equals", value: false }, { inputId: "penetrating_trauma", operator: "equals", value: false }, { inputId: "known_brain_tumor", operator: "equals", value: false }, { inputId: "preexisting_neurologic_disorder_complicating_assessment", operator: "equals", value: false }, { inputId: "prior_neuroimaging_before_transfer", operator: "equals", value: false }, { inputId: "ventricular_shunt", operator: "equals", value: false }, { inputId: "bleeding_disorder", operator: "equals", value: false }] },
      { ...booleanInput("abnormal_behavior_per_parent",{es:"No actúa normal según padres/tutores",en:"Not acting normally according to parent/guardian"}), visibleWhen: [{ inputId: "blunt_head_trauma", operator: "equals", value: true }, { inputId: "presentation_within_24h", operator: "equals", value: true }, { inputId: "trivial_mechanism_only", operator: "equals", value: false }, { inputId: "penetrating_trauma", operator: "equals", value: false }, { inputId: "known_brain_tumor", operator: "equals", value: false }, { inputId: "preexisting_neurologic_disorder_complicating_assessment", operator: "equals", value: false }, { inputId: "prior_neuroimaging_before_transfer", operator: "equals", value: false }, { inputId: "ventricular_shunt", operator: "equals", value: false }, { inputId: "bleeding_disorder", operator: "equals", value: false }] }
    ]
  },
  pecarn_tbi_2_or_more: {
    calculationStatus: "metadata_ready",
    ...
    inputs: [
      ...
      { ...booleanInput("signs_of_basilar_skull_fracture",{es:"Signos de fractura basilar",en:"Signs of basilar skull fracture"}), visibleWhen: [{ inputId: "blunt_head_trauma", operator: "equals", value: true }, { inputId: "presentation_within_24h", operator: "equals", value: true }, { inputId: "trivial_mechanism_only", operator: "equals", value: false }, { inputId: "penetrating_trauma", operator: "equals", value: false }, { inputId: "known_brain_tumor", operator: "equals", value: false }, { inputId: "preexisting_neurologic_disorder_complicating_assessment", operator: "equals", value: false }, { inputId: "prior_neuroimaging_before_transfer", operator: "equals", value: false }, { inputId: "ventricular_shunt", operator: "equals", value: false }, { inputId: "bleeding_disorder", operator: "equals", value: false }] },
      { ...booleanInput("history_of_loss_of_consciousness",{es:"Pérdida de conciencia",en:"Loss of consciousness"}), visibleWhen: [{ inputId: "blunt_head_trauma", operator: "equals", value: true }, { inputId: "presentation_within_24h", operator: "equals", value: true }, { inputId: "trivial_mechanism_only", operator: "equals", value: false }, { inputId: "penetrating_trauma", operator: "equals", value: false }, { inputId: "known_brain_tumor", operator: "equals", value: false }, { inputId: "preexisting_neurologic_disorder_complicating_assessment", operator: "equals", value: false }, { inputId: "prior_neuroimaging_before_transfer", operator: "equals", value: false }, { inputId: "ventricular_shunt", operator: "equals", value: false }, { inputId: "bleeding_disorder", operator: "equals", value: false }] },
      { ...booleanInput("history_of_vomiting",{es:"Vómitos",en:"Vomiting"}), visibleWhen: [{ inputId: "blunt_head_trauma", operator: "equals", value: true }, { inputId: "presentation_within_24h", operator: "equals", value: true }, { inputId: "trivial_mechanism_only", operator: "equals", value: false }, { inputId: "penetrating_trauma", operator: "equals", value: false }, { inputId: "known_brain_tumor", operator: "equals", value: false }, { inputId: "preexisting_neurologic_disorder_complicating_assessment", operator: "equals", value: false }, { inputId: "prior_neuroimaging_before_transfer", operator: "equals", value: false }, { inputId: "ventricular_shunt", operator: "equals", value: false }, { inputId: "bleeding_disorder", operator: "equals", value: false }] },
      ...
      { ...booleanInput("severe_headache",{es:"Cefalea intensa",en:"Severe headache"}), visibleWhen: [{ inputId: "blunt_head_trauma", operator: "equals", value: true }, { inputId: "presentation_within_24h", operator: "equals", value: true }, { inputId: "trivial_mechanism_only", operator: "equals", value: false }, { inputId: "penetrating_trauma", operator: "equals", value: false }, { inputId: "known_brain_tumor", operator: "equals", value: false }, { inputId: "preexisting_neurologic_disorder_complicating_assessment", operator: "equals", value: false }, { inputId: "prior_neuroimaging_before_transfer", operator: "equals", value: false }, { inputId: "ventricular_shunt", operator: "equals", value: false }, { inputId: "bleeding_disorder", operator: "equals", value: false }] }
    ]
  },
  catch_tbi: {
    calculationStatus: "metadata_ready",
    ...
    inputs: [
      ...
      { ...booleanInput("signs_of_basal_skull_fracture",{es:"Signos de fractura basal",en:"Signs of basal skull fracture"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] },
  ...
  chalice_tbi: {
    ...
    inputs: [
      ...
      { ...booleanInput("witnessed_loss_of_consciousness_over_5_minutes",{es:"Pérdida de conciencia presenciada >5 min",en:"Witnessed LOC >5 min"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] },
      { ...booleanInput("history_of_amnesia_over_5_minutes",{es:"Amnesia >5 min",en:"Amnesia >5 min"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] },
      { ...booleanInput("abnormal_drowsiness",{es:"Somnolencia anormal",en:"Abnormal drowsiness"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] },
      { ...booleanInput("three_or_more_vomiting_episodes",{es:"≥3 episodios de vómitos",en:"≥3 vomiting episodes"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] },
      { ...booleanInput("suspicion_of_non_accidental_injury",{es:"Sospecha de lesión no accidental",en:"Suspicion of non-accidental injury"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] },
      { ...booleanInput("post_traumatic_seizure_without_epilepsy",{es:"Convulsión postraumática sin epilepsia",en:"Post-traumatic seizure without epilepsy"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] },
      { ...booleanInput("gcs_less_than_14_or_under_1_less_than_15",{es:"GCS <14, o <15 si <1 año",en:"GCS <14, or <15 if under 1 year"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] },
      { ...booleanInput("suspected_penetrating_or_depressed_skull_injury_or_tense_fontanelle",{es:"Lesión penetrante/deprimida o fontanela tensa",en:"Penetrating/depressed injury or tense fontanelle"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] },
      { ...booleanInput("signs_of_basal_skull_fracture",{es:"Signos de fractura basal",en:"Signs of basal skull fracture"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] },
      { ...booleanInput("focal_neurology",{es:"Neurología focal",en:"Focal neurology"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] },
      { ...booleanInput("bruise_swelling_laceration_over_5cm_under_1_year",{es:">5 cm de lesión de cuero cabelludo si <1 año",en:">5 cm scalp injury if under 1 year"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }, { inputId: "age_years", operator: "lt", value: 1 }] },
      { ...booleanInput("high_speed_road_traffic_mechanism",{es:"Tráfico de alta velocidad >40 mph (>64 km/h)",en:"High-speed road traffic >40 mph (>64 km/h)"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] },
      { ...booleanInput("fall_over_3_metres",{es:"Caída >3 m",en:"Fall >3 m"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] },
      { ...booleanInput("high_speed_projectile_or_object",{es:"Proyectil u objeto de alta energía",en:"High-speed projectile or object"}), visibleWhen: [{ inputId: "head_injury_present", operator: "equals", value: true }] }
    ]
  }
};
...
export const clinicalTools: ClinicalToolMetadata[] = [
  ...
  makeTool("silverman_andersen", "silverman-andersen", "Silverman-Andersen", "Score de Silverman-Andersen", "Silverman-Andersen Score", "neonatology", "respiratory_distress", "score", "Recien nacidos con dificultad respiratoria", "Newborns with respiratory distress", "Cuantifica dificultad respiratoria neonatal mediante signos clinicos.", "Scores neonatal respiratory distress using clinical signs.", "implemented", "moderate", "low", baseValidationNotes.ready),
  makeTool("wood_downes_ferres", "wood-downes-ferres", "WDF", "Score de Wood-Downes-Ferres", "Wood-Downes-Ferres Score", "respiratory", "bronchiolitis_wheezing", "score", "Lactantes y ninos con bronquiolitis u obstruccion respiratoria segun variante", "Infants and children with bronchiolitis or obstructive respiratory distress depending on variant", "Evalua gravedad de dificultad respiratoria obstructiva.", "Assesses severity of obstructive respiratory distress.", "implemented", "secondary_source", "medium", woodDownesValidationNotes),
  makeTool("ballard", "ballard", "Ballard", "Ballard / New Ballard", "Ballard / New Ballard", "neonatology", "gestational_age", "score", "Recien nacidos con edad gestacional incierta", "Newborns with uncertain gestational age", "Estima edad gestacional con madurez fisica y neuromuscular.", "Estimates gestational age using physical and neuromuscular maturity.", "implemented", "original_derivation_study", "medium", ballardValidationNotes),
  makeTool("dubowitz", "dubowitz", "Dubowitz", "Dubowitz", "Dubowitz Score", "neonatology", "gestational_age", "score", "Recien nacidos", "Newborns", "Herramienta de estimacion de edad gestacional basada en madurez neonatal.", "Gestational age assessment based on neonatal maturity.", "implemented", "original_derivation_study", "medium", dubowitzValidationNotes),
  ...
  makeTool("westley_croup", "westley-croup-score", "Westley", "Westley Croup Score", "Westley Croup Score", "respiratory", "croup", "score", "Ninos con crup", "Children with croup", "Evalua gravedad del crup mediante signos clinicos.", "Assesses croup severity using clinical signs.", "implemented", "moderate", "medium", westleyQaValidationNotes),
  ...
  makeTool("risc", "risc", "RISC", "RISC", "RISC", "respiratory", "pneumonia", "score", "Ninos con neumonia", "Children with pneumonia", "Score de gravedad de neumonia identificado en recomendaciones.", "Pneumonia severity score identified in recommendations.", "implemented", "pending_verification", "medium", baseValidationNotes.future),
  makeTool("mrisc", "mrisc", "mRISC", "mRISC", "mRISC", "respiratory", "pneumonia", "score", "Ninos con neumonia", "Children with pneumonia", "Variante modificada RISC para neumonia.", "Modified RISC variant for pneumonia.", "implemented", "pending_verification", "medium", baseValidationNotes.future),
