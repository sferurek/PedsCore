...
const referenceSurface = (seed: ReferenceSurfaceSeed): ClinicalToolMetadata =>
  makeTool(
    ...
    [docRef(`${seed.id}_master_plan`, `PedsCore Clinical Master Implementation Plan v12: ${seed.nameEn}`, seed.evidenceLevel)]
  );
...
const legacyClinicalTools: ClinicalToolMetadata[] = [
  makeTool(
    "apgar",
    "apgar",
    "Apgar",
...
const societyExpansionSurfaces: ClinicalToolMetadata[] = [
  referenceSurface({ id:"comfort_b", slug:"comfort-b", shortName:"COMFORT-B", nameEs:"COMFORT / COMFORT-B", nameEn:"COMFORT / COMFORT-B", category:"intensive_care", subcategory:"sedation_distress", type:"scale", populationEs:"Niños en cuidados intensivos pediátricos", populationEn:"Children in pediatric intensive care", descriptionEs:"Referencia para valoración estructurada de distrés y sedación en cuidados intensivos pediátricos.", descriptionEn:"Reference for structured assessment of distress and sedation in pediatric intensive care.", evidenceLevel:"external_validation_study", regulatoryRisk:"high" }),
  referenceSurface({ id:"n_pass", slug:"n-pass", shortName:"N-PASS", nameEs:"N-PASS", nameEn:"N-PASS", category:"pain", subcategory:"neonatal_pain", type:"scale", populationEs:"Recién nacidos, incluidos prematuros, en valoración de dolor y sedación", populationEn:"Newborns, including preterm infants, undergoing pain and sedation assessment", descriptionEs:"Escala neonatal de referencia para dolor, agitación y sedación; el formulario operativo no se reproduce localmente.", descriptionEn:"Neonatal reference scale for pain, agitation and sedation; the operational form is not reproduced locally.", evidenceLevel:"external_validation_study", regulatoryRisk:"high" }),
  referenceSurface({ id:"edin", slug:"edin", shortName:"EDIN", nameEs:"EDIN", nameEn:"EDIN", category:"pain", subcategory:"neonatal_pain", type:"scale", populationEs:"Recién nacidos con dolor prolongado", populationEn:"Newborns with prolonged pain", descriptionEs:"Referencia para valoración de dolor neonatal prolongado.", descriptionEn:"Reference for prolonged neonatal pain assessment.", evidenceLevel:"external_validation_study", regulatoryRisk:"medium" }),
  referenceSurface({ id:"nfcs", slug:"nfcs", shortName:"NFCS", nameEs:"Neonatal Facial Coding System", nameEn:"Neonatal Facial Coding System", category:"pain", subcategory:"neonatal_pain", type:"scale", populationEs:"Recién nacidos durante procedimientos o situaciones dolorosas", populationEn:"Newborns during painful procedures or events", descriptionEs:"Sistema de referencia basado en expresión facial para valorar dolor neonatal.", descriptionEn:"Reference facial-expression coding system for neonatal pain assessment.", evidenceLevel:"external_validation_study", regulatoryRisk:"medium" }),
  referenceSurface({ id:"cmas", slug:"cmas", shortName:"CMAS", nameEs:"Childhood Myositis Assessment Scale", nameEn:"Childhood Myositis Assessment Scale", category:"neurology", subcategory:"juvenile_myositis", type:"scale", populationEs:"Niños y adolescentes con miositis inflamatoria juvenil", populationEn:"Children and adolescents with juvenile inflammatory myositis", descriptionEs:"Referencia para valoración funcional en miositis juvenil y seguimiento longitudinal.", descriptionEn:"Reference for functional assessment and longitudinal follow-up in juvenile myositis.", evidenceLevel:"external_validation_study", regulatoryRisk:"medium" }),
  referenceSurface({ id:"mmt8", slug:"mmt8", shortName:"MMT8", nameEs:"Manual Muscle Testing 8", nameEn:"Manual Muscle Testing 8", category:"neurology", subcategory:"juvenile_myositis", type:"scale", populationEs:"Pacientes con miositis inflamatoria en valoración de fuerza muscular", populationEn:"Patients with inflammatory myositis undergoing muscle-strength assessment", descriptionEs:"Referencia para valoración estructurada de fuerza muscular en miositis.", descriptionEn:"Reference for structured muscle-strength assessment in myositis.", evidenceLevel:"external_validation_study", regulatoryRisk:"medium" }),
  referenceSurface({ id:"chaq", slug:"chaq", shortName:"CHAQ", nameEs:"Childhood Health Assessment Questionnaire", nameEn:"Childhood Health Assessment Questionnaire", category:"adolescent_medicine", subcategory:"rheumatology_function", type:"scale", populationEs:"Niños y adolescentes con enfermedad reumatológica según el instrumento oficial", populationEn:"Children and adolescents with rheumatic disease according to the official instrument", descriptionEs:"Herramienta externa de referencia para discapacidad y función física en reumatología pediátrica.", descriptionEn:"External reference tool for disability and physical function in pediatric rheumatology.", evidenceLevel:"external_validation_study", regulatoryRisk:"medium" }),
  referenceSurface({ id:"j4s", slug:"j4s", shortName:"J4S", nameEs:"J4S", nameEn:"J4S", category:"adolescent_medicine", subcategory:"rheumatology_function", type:"scale", populationEs:"Niños y adolescentes con enfermedad reumatológica según la población validada", populationEn:"Children and adolescents with rheumatic disease in the validated population", descriptionEs:"Superficie de referencia para valoración funcional reumatológica pediátrica.", descriptionEn:"Reference surface for pediatric rheumatology functional assessment.", evidenceLevel:"external_validation_study", regulatoryRisk:"medium" }),
  referenceSurface({ id:"jdm_disease_activity_score", slug:"jdm-disease-activity-score", shortName:"JDM DAS", nameEs:"Disease Activity Score de dermatomiositis juvenil", nameEn:"Juvenile Dermatomyositis Disease Activity Score", category:"neurology", subcategory:"juvenile_myositis", type:"scale", populationEs:"Niños y adolescentes con dermatomiositis juvenil", populationEn:"Children and adolescents with juvenile dermatomyositis", descriptionEs:"Referencia para actividad de enfermedad en dermatomiositis juvenil.", descriptionEn:"Reference for disease activity assessment in juvenile dermatomyositis.", evidenceLevel:"external_validation_study", regulatoryRisk:"high" }),
  referenceSurface({ id:"myositis_damage_index", slug:"myositis-damage-index", shortName:"MDI", nameEs:"Myositis Damage Index", nameEn:"Myositis Damage Index", category:"neurology", subcategory:"juvenile_myositis", type:"scale", populationEs:"Pacientes con miositis inflamatoria en seguimiento de daño acumulado", populationEn:"Patients with inflammatory myositis undergoing cumulative-damage follow-up", descriptionEs:"Referencia para documentar daño acumulado relacionado con miositis.", descriptionEn:"Reference for documenting cumulative myositis-related damage.", evidenceLevel:"external_validation_study", regulatoryRisk:"medium" }),
  referenceSurface({ id:"pgals", slug:"pgals", shortName:"pGALS", nameEs:"pGALS", nameEn:"pGALS", category:"adolescent_medicine", subcategory:"musculoskeletal_examination", type:"scale", populationEs:"Niños y adolescentes que requieren cribado musculoesquelético", populationEn:"Children and adolescents requiring musculoskeletal screening", descriptionEs:"Marco de exploración musculoesquelética pediátrica estructurada.", descriptionEn:"Structured pediatric musculoskeletal examination framework.", evidenceLevel:"external_validation_study", regulatoryRisk:"low" }),
  referenceSurface({ id:"prems", slug:"prems", shortName:"pREMS", nameEs:"pREMS", nameEn:"pREMS", category:"emergency", subcategory:"early_warning", type:"score", populationEs:"Pacientes pediátricos en contextos agudos según la población validada", populationEn:"Pediatric patients in acute-care settings according to the validated population", descriptionEs:"Escala de referencia para valoración fisiológica y estratificación de gravedad pediátrica.", descriptionEn:"Reference score for physiologic assessment and pediatric severity stratification.", evidenceLevel:"external_validation_study", regulatoryRisk:"high" }),
  referenceSurface({ id:"modified_ross", slug:"modified-ross", shortName:"Ross", nameEs:"Clasificación modificada de Ross", nameEn:"Modified Ross Classification", category:"cardiology", subcategory:"heart_failure", type:"scale", populationEs:"Lactantes y niños con sospecha o seguimiento de insuficiencia cardiaca", populationEn:"Infants and children with suspected or monitored heart failure", descriptionEs:"Clasificación clínica de referencia para gravedad de insuficiencia cardiaca pediátrica.", descriptionEn:"Reference clinical classification for pediatric heart-failure severity.", evidenceLevel:"peer_reviewed_review", regulatoryRisk:"high" }),
  referenceSurface({ id:"pedmidas", slug:"pedmidas", shortName:"PedMIDAS", nameEs:"PedMIDAS", nameEn:"PedMIDAS", category:"neurology", subcategory:"migraine_disability", type:"scale", populationEs:"Niños y adolescentes con migraña según la población validada", populationEn:"Children and adolescents with migraine in the validated population", descriptionEs:"Herramienta externa de referencia para discapacidad relacionada con migraña pediátrica.", descriptionEn:"External reference tool for pediatric migraine-related disability.", evidenceLevel:"external_validation_study", regulatoryRisk:"medium" }),
  referenceSurface({ id:"scared", slug:"scared", shortName:"SCARED", nameEs:"SCARED", nameEn:"SCARED", category:"adolescent_medicine", subcategory:"anxiety", type:"scale", populationEs:"Niños y adolescentes en cribado de síntomas de ansiedad", populationEn:"Children and adolescents undergoing anxiety-symptom screening", descriptionEs:"Herramienta externa de referencia para cribado de síntomas de ansiedad.", descriptionEn:"External reference tool for anxiety-symptom screening.", evidenceLevel:"external_validation_study", regulatoryRisk:"high" }),
  referenceSurface({ id:"psc", slug:"pediatric-symptom-checklist", shortName:"PSC", nameEs:"Pediatric Symptom Checklist", nameEn:"Pediatric Symptom Checklist", category:"adolescent_medicine", subcategory:"behavioral_health", type:"scale", populationEs:"Niños y adolescentes en cribado psicosocial según la versión oficial", populationEn:"Children and adolescents undergoing psychosocial screening according to the official version", descriptionEs:"Herramienta externa de referencia para cribado psicosocial y conductual.", descriptionEn:"External reference tool for psychosocial and behavioral screening.", evidenceLevel:"external_validation_study", regulatoryRisk:"high" }),
  referenceSurface({ id:"acq", slug:"asthma-control-questionnaire", shortName:"ACQ", nameEs:"Asthma Control Questionnaire", nameEn:"Asthma Control Questionnaire", category:"respiratory", subcategory:"asthma_control", type:"scale", populationEs:"Pacientes con asma según la versión y edad validadas del instrumento", populationEn:"Patients with asthma according to the validated instrument version and age", descriptionEs:"Herramienta externa de referencia para control del asma; el cuestionario protegido no se reproduce localmente.", descriptionEn:"External reference tool for asthma control; the protected questionnaire is not reproduced locally.", evidenceLevel:"external_validation_study", regulatoryRisk:"high" }),
  referenceSurface({ id:"wpcdai", slug:"wpcdai", shortName:"wPCDAI", nameEs:"Índice pediátrico ponderado de actividad de Crohn", nameEn:"Weighted Pediatric Crohn Disease Activity Index", category:"growth_nutrition", subcategory:"inflammatory_bowel_disease", type:"score", populationEs:"Niños y adolescentes con enfermedad de Crohn", populationEn:"Children and adolescents with Crohn disease", descriptionEs:"Índice de referencia para actividad de enfermedad de Crohn; la automatización ponderada queda para una fase clínica específica.", descriptionEn:"Reference index for Crohn-disease activity; weighted automation is reserved for a dedicated clinical phase.", evidenceLevel:"external_validation_study", regulatoryRisk:"high" }),
  referenceSurface({ id:"fnass_21", slug:"fnass-21", shortName:"FNASS", nameEs:"Finnegan Neonatal Abstinence Scoring System (21 ítems)", nameEn:"Finnegan Neonatal Abstinence Scoring System (21-item)", category:"neonatology", subcategory:"neonatal_abstinence", type:"scale", populationEs:"Recién nacidos con sospecha de síndrome de abstinencia neonatal", populationEn:"Newborns with suspected neonatal abstinence syndrome", descriptionEs:"Referencia nominada al sistema Finnegan de 21 ítems. PedsCore no reproduce el formulario operativo completo mientras sus condiciones de reutilización no estén cerradas.", descriptionEn:"Named reference to the 21-item Finnegan system. PedsCore does not reproduce the full operational form while reuse conditions remain unresolved.", evidenceLevel:"original_derivation_study", regulatoryRisk:"high" })
];

export const clinicalTools: ClinicalToolMetadata[] = [
  ...legacyClinicalTools.filter((toolMetadata) => !retiredFinalSurfaceIds.has(toolMetadata.id)),
  ...societyExpansionSurfaces
];
