# WHO Growth Data Attribution

Suggested attribution for WHO Child Growth Standards:
...
Imported length/height-for-age 0-5 years source files:
...
Imported head circumference-for-age 0-5 years source files:
...
Imported weight-for-length / weight-for-height 0-5 years source files:
...
Imported weight-for-age 5-10 years source files:
...
Imported height-for-age 5-19 years source files:
...
Adaptation disclaimer:

This material may contain adaptations of WHO data. The adaptation is not created
by WHO. WHO is not responsible for the content or accuracy of this adaptation.
The original source should be consulted for authoritative use.

No WHO endorsement:

Use of WHO data in PedsCore does not imply endorsement by WHO.
