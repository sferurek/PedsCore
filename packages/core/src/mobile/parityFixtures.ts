...
const fixtureSeeds: FixtureSeed[] = [
  ...
  { id:"pass-zero", toolId:"pass", input:{age_years:8,work_of_breathing:"work_0",wheezing:"wheeze_0",prolonged_expiration:"expiration_0"} },
  { id:"pass-max", toolId:"pass", input:{age_years:8,work_of_breathing:"work_2",wheezing:"wheeze_2",prolonged_expiration:"expiration_2"} },
  { id:"gorelick-zero", toolId:"gorelick_dehydration", input:{abnormal_general_appearance:false,prolonged_capillary_refill:false,absent_tears:false,dry_mucous_membranes:false,sunken_eyes:false,deep_breathing:false,weak_pulses:false,reduced_skin_elasticity:false,tachycardia:false,reduced_urine_output:false} },
  { id:"gorelick-ten", toolId:"gorelick_dehydration", input:{abnormal_general_appearance:true,prolonged_capillary_refill:true,absent_tears:true,dry_mucous_membranes:true,sunken_eyes:true,deep_breathing:true,weak_pulses:true,reduced_skin_elasticity:true,tachycardia:true,reduced_urine_output:true} },
  { id:"risc-low", toolId:"risc", input:{age_months:12,hiv_negative:true,spo2_room_air:98,chest_indrawing:false,wheezing:false,refusing_feeds:false,weight_for_age_z:0} },
  { id:"risc-high", toolId:"risc", input:{age_months:12,hiv_negative:true,spo2_room_air:88,chest_indrawing:true,wheezing:false,refusing_feeds:true,weight_for_age_z:-3} },
  { id:"mrisc-low", toolId:"mrisc", input:{age_months:24,history_unconscious:false,unable_to_drink:false,night_sweats:false,chest_indrawing:false,alert_and_awake:true,malaria:false,dehydrated:false,weight_for_age_z:0} },
  { id:"mrisc-high", toolId:"mrisc", input:{age_months:24,history_unconscious:true,unable_to_drink:true,night_sweats:false,chest_indrawing:true,alert_and_awake:false,malaria:false,dehydrated:true,weight_for_age_z:-3} },
  { id:"bms-zero", toolId:"bacterial_meningitis_score", input:{age_days:365,csf_wbc:20,csf_rbc:0,antibiotics_before_lp:false,critical_illness:false,immunosuppression:false,cns_device_or_recent_neurosurgery:false,other_bacterial_infection:false,csf_gram_positive:false,csf_anc:100,csf_protein_mg_dl:40,peripheral_anc:5000,seizure:false} },
  { id:"bms-positive", toolId:"bacterial_meningitis_score", input:{age_days:365,csf_wbc:20,csf_rbc:0,antibiotics_before_lp:false,critical_illness:false,immunosuppression:false,cns_device_or_recent_neurosurgery:false,other_bacterial_infection:false,csf_gram_positive:true,csf_anc:1200,csf_protein_mg_dl:100,peripheral_anc:12000,seizure:true} },
  { id:"bell-suspected", toolId:"modified_bell_nec", input:{systemic_instability:true,mild_gi_signs:true,gross_bloody_stool:false,absent_bowel_sounds_or_tenderness:false,mild_acidosis_or_thrombocytopenia:false,abdominal_cellulitis_or_mass:false,hypotension_dic_or_neutropenia:false,pneumatosis_intestinalis:false,portal_venous_gas:false,ascites:false,pneumoperitoneum:false} },
  { id:"bell-perforation", toolId:"modified_bell_nec", input:{systemic_instability:true,mild_gi_signs:true,gross_bloody_stool:true,absent_bowel_sounds_or_tenderness:true,mild_acidosis_or_thrombocytopenia:true,abdominal_cellulitis_or_mass:true,hypotension_dic_or_neutropenia:true,pneumatosis_intestinalis:true,portal_venous_gas:true,ascites:true,pneumoperitoneum:true} },
  { id:"phoenix-zero", toolId:"phoenix_sepsis", input:{age_months:60,suspected_infection:true,birth_hospitalization_before_discharge:false,postconceptional_age_at_least_37_weeks:true,fio2_fraction:0.21,pao2_mmhg:100,spo2_percent:97,any_respiratory_support:false,invasive_mechanical_ventilation:false,vasoactive_count:0,lactate_mmol_l:1,map_mmhg:80,platelets_10e3_ul:200,inr:1,d_dimer_mg_l_feu:1,fibrinogen_mg_dl:200,gcs:15,both_pupils_fixed:false} },
  { id:"phoenix-shock", toolId:"phoenix_sepsis", input:{age_months:60,suspected_infection:true,birth_hospitalization_before_discharge:false,postconceptional_age_at_least_37_weeks:true,fio2_fraction:0.8,pao2_mmhg:60,spo2_percent:90,any_respiratory_support:true,invasive_mechanical_ventilation:true,vasoactive_count:2,lactate_mmol_l:12,map_mmhg:30,platelets_10e3_ul:50,inr:2,d_dimer_mg_l_feu:3,fibrinogen_mg_dl:80,gcs:8,both_pupils_fixed:false} },
  { id:"modified-tal-low", toolId:"modified_tal", input:{age_months:12,respiratory_rate:25,wheeze_crackles:"wheeze_0",retractions:"retractions_0",spo2:98} },
  { id:"taussig-low", toolId:"taussig_croup", input:{stridor:"stridor_0",air_entry:"air_entry_0",color:"color_0",retractions:"retractions_0",consciousness:"consciousness_0"} },
  { id:"parc-baseline", toolId:"parc", input:{age_years:10,sex:"female",pain_duration:"lt24",pain_with_walking:false,migration_to_rlq:false,maximal_rlq_tenderness:false,abdominal_guarding:false,anc_10e3_ul:5} },
  { id:"wpcdai-low", toolId:"wpcdai", input:{abdominal_pain:"0",wellbeing:"0",stools:"0",weight_change:"0",perirectal_disease:"0",extraintestinal_manifestations:"0",esr_mm_h:10,albumin_g_dl:4} }
];
